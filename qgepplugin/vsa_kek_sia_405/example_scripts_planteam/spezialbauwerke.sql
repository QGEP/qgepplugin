SELECT ab.obj_id AS bauwerk_obj_id,
	...
	ab_text.texthali,
	ab_text.textvali,
	max(ab_nach.nutzungsart_ist) AS kanal_nutzungsart_ist
   ...
   WHERE an.t_type::text = 'abwasserknoten'::text AND an_nach.obj_id IS NOT NULL AND ab.detailgeometrie IS NOT NULL
   GROUP BY
    ab.obj_id,
    ab.detailgeometrie,
    ab.baujahr,
