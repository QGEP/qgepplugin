...
UPDATE qgep_od.reach SET progression_geometry=ST_RemoveRepeatedPoints(progression_geometry, 0.001) WHERE NOT ST_EQUALS(progression_geometry, ST_RemoveRepeatedPoints(progression_geometry, 0.001));
