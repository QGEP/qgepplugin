...
from . import SIA405_Base_f_LV95


class Noeud_hydraulique(SIA405_Base_f_LV95.SIA405_BaseClass):  # Hydraulischer_Knoten(SIA405_Base_LV95.SIA405_BaseClass)
    __tablename__ = 'noeud_hydraulique'
    __table_args__ = {'schema': 'pg2ili_wasser'}

class Noeud_hydraulique_Texte(SIA405_Base_f_LV95.SIA405_TextePos):  # Hydraulischer_Knoten_Text(SIA405_Base_LV95.SIA405_TextPos)
    __tablename__ = 'noeud_hydraulique_texte'
    __table_args__ = {'schema': 'pg2ili_wasser'}

class Troncon_hydraulique(SIA405_Base_f_LV95.SIA405_BaseClass):  # Hydraulischer_Strang(SIA405_Base_LV95.SIA405_BaseClass)
    __tablename__ = 'troncon_hydraulique'
    __table_args__ = {'schema': 'pg2ili_wasser'}

class Troncon_hydraulique_Texte(SIA405_Base_f_LV95.SIA405_TextePos):  # Hydraulischer_Strang_Text(SIA405_Base_LV95.SIA405_TextPos)
    __tablename__ = 'troncon_hydraulique_texte'
    __table_args__ = {'schema': 'pg2ili_wasser'}

class Conduite(SIA405_Base_f_LV95.SIA405_BaseClass):  # Leitung(SIA405_Base_LV95.SIA405_BaseClass)
    __tablename__ = 'conduite'
    __table_args__ = {'schema': 'pg2ili_wasser'}

class Conduite_Texte(SIA405_Base_f_LV95.SIA405_TextePos):  # Leitung_Text(SIA405_Base_LV95.SIA405_TextPos)
    __tablename__ = 'conduite_texte'
    __table_args__ = {'schema': 'pg2ili_wasser'}

class Lieu_de_fuite(SIA405_Base_f_LV95.SIA405_BaseClass):  # Schadenstelle(SIA405_Base_LV95.SIA405_BaseClass)
    __tablename__ = 'lieu_de_fuite'
    __table_args__ = {'schema': 'pg2ili_wasser'}

# ABSTRACT !
class Noeud_de_conduite(SIA405_Base_f_LV95.SIA405_BaseClass):  # Leitungsknoten(SIA405_Base_LV95.SIA405_BaseClass)
    __tablename__ = 'noeud_de_conduite'
    __table_args__ = {'schema': 'pg2ili_wasser'}

class Noeud_de_conduite_Texte(SIA405_Base_f_LV95.SIA405_TextePos):  # Leitungsknoten_Text(SIA405_Base_LV95.SIA405_TextPos)
...
class Construction_speciale(SIA405_Base_f_LV95.SIA405_BaseClass):  # Spezialbauwerk(SIA405_Base_LV95.SIA405_BaseClass)
...
class Construction_speciale_Texte(SIA405_Base_f_LV95.SIA405_TextePos):  # Spezialbauwerk_Text(SIA405_Base_LV95.SIA405_TextPos)
    __tablename__ = 'construction_speciale_texte'
    __table_args__ = {'schema': 'pg2ili_wasser'}

class Position_plan_d_ensemble(SIA405_Base_f_LV95.SIA405_SymbolePos):  # Uebersichtsplanposition(SIA405_Base_LV95.SIA405_SymbolPos)
