    ...
    for row in session.query(QWAT.network_element):
        ...
        # --- _relations_ ---
        # REF_pipe_fk_node_a, distributor, district, folder, object_reference, precision, precisionalti, pressurezone, status, visible
    ...
    for row in session.query(QWAT.tank):
        ...
        # --- _relations_ ---
        # REF_chamber_id_fkey, REF_cover_fk_installation, REF_installation_fk_parent, REF_meter_id_fkey, REF_part_id_fkey, REF_pipe_fk_node_a, REF_pressurecontrol_id_fkey, REF_pump_id_fkey, REF_samplingpoint_id_fkey, REF_source_id_fkey, REF_subscriber_id_fkey, REF_treatment_id_fkey, cistern, distributor, district, folder, installation, object_reference, overflow, precision, precisionalti, pressurezone, remote_type, status, tank_firestorage, visible, watertype
